    ...
    <form action="{{url('admin/config')}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                <th>排序：</th>
                <td>
                    <input type="text" class="sm" name="conf_order" value="0"><span><i class="fa fa-exclamation-circle yellow"></i>默认排序为0</span>
                </td>
            </tr>
            <tr>
                <th>类型：</th>
            ...
            <tr>
                <th>类型值：</th>
                <td>
                    <input type="text" class="lg field_value" name="field_value" >
