        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" size="50" name="art_thumb" value="{{$field->art_thumb}}" id="article_thumb">
            ...
            <tr>
                ...
                <td>
                    ...
                    <script id="editor" name="art_content" type="text/plain"
                            style="width:860px;height:500px;">{!! $field->art_content !!}}
                    </script>
                    <script>
