...
<div class="top_box">
    <div class="top_left">
        <div class="logo">Mr.xu 后台博客管理</div>
        <ul>
            <li><a href="{{url('/')}}" class="active" target="_blank">前台首页</a></li>
...
<div class="menu_box">
    <ul>
        ...
        <li>
            ...
            <ul class="sub_menu">
                <li><a href="{{url('admin/links')}}" target="main"><i class="fa fa-fw fa-refresh"></i>友情链接</a></li>
        ...
        <li>
            ...
            <ul class="sub_menu">
                ...
                <li><a href="http://www.veryhuo.com/a/manual/php/" target="main"><i
                                class="fa fa-fw fa-tags"></i>php手册</a></li>
            </ul>
        </li>
    </ul>
</div>
...
<div class="bottom_box">
    CopyRight © 2016. Powered By <a href="http://www.apps.com">http://www.apps.com</a>
</div>
<!--底部 结束-->
@endsection
